...
public class FHIRCreatefromDBfromWeight {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    context.addRoutes(new RouteBuilder(){
			...
			public void configure(){
				...
				.setBody(constant("SELECT * FROM " + privateData.weightTable + " WHERE Fid is NULL"))
				...
				.process(new Processor() {
					...
					public void process(Exchange exchange) throws Exception {
				        ...
				        exchange.getIn().setBody(cp.getFHIRBundles(body, IDlist, "BW"));
						
					}
					
				})
//				.marshal().fhirJson(true) 
//				.to("file:src/test?fileName=weightfhir")
		        ...
		        .process(new Processor() {
					public void process(Exchange exchange) throws Exception {
						...
						String sql = func.getUpdateSql(privateData.weightTable, "Id", result, IDlist);
